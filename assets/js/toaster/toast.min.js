(function (a) {
	function f(b) {
		...
		switch (t) {
			...
			case "warning":
				...
				break;
			case "error":
				(e = a.toastDefaults.style.error || "bg-danger"), (c = a.toastDefaults.style.error || "text-white");
		}
	...
	a.toastDefaults = { position: "top-right", dismissible: !0, stackable: !0, pauseDelayOnHover: !0, style: { toast: "", info: "", success: "", warning: "", error: "" } };
