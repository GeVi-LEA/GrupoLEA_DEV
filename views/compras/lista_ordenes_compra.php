<div class="row mt-1 req-estados">
    ...
    <div class="col-3 menu-iconos d-flex justify-content-end">
        ...
        <div class="mr-4">
            ...
            <span id="enviarOrden" title="Enviar orden" class="material-icons far fa-envelope"></span>
        </div>
    </div>
</div>
    ...
    <table class="table tabla-registros" id="tablaRegistros">
        ...
        <tbody>
            ...
            <tr class="tr">
                ...
                <td>
                    <div id="tdEstatus" class="<?= Utils::getClaseEstado($o['clave']); ?> estatus-tabla" title="<?= $o['descEstatus'] ?>"><span id="estatus"><?= $o['estatus']; ?></span></div>
                </td>
                <td>
                    ...
                    <table class="table tabla-embarques">
                        ...
                        <tbody>
                            ...
                            <tr class="background-tabla-embarques">
                                ...
                                <td class="w-td-30 px-0 mx-0"><input id="factura" type="hidden" value="<?= $embarque['factura']; ?>" /><i id="showFactura" class="i-pdf material-icons far fa-file-pdf" title="Ver factura"
                                        <?= $embarque['factura'] == null ? 'hidden' : '' ?>></i></td>
                                ...
                                <td class="w-td-30 px-0 mx-0"><input type="hidden" id="pedimento" value="<?= $embarque['pedimentoDoc']; ?>" /><i id="showPedimento" class="i-pdf material-icons far fa-file-pdf"
                                        title="Ver pedimento" <?= $embarque['pedimentoDoc'] == null ? 'hidden' : '' ?>></i></td>
                                <td><span><?= date('d/m/Y', strtotime($embarque['fecha_alta'])); ?></span></td>
                                <td><span>
                                        <div id="tdEstatus" class="<?= Utils::getClaseEstado($embarque['clave']); ?> estatus-tabla estatus-small"><span id="estatus"><?= $embarque['estatus']; ?></span></div>
                                </td>
                            </tr>
                            <?php $i++; endforeach; ?>
                    ...
                    <table class="table tabla-embarques">
                        <tbody>
                            ...
                            <tr class="background-tabla-embarques">
                                ...
                                <td><i class="mr-1 fas fa-paperclip"></i><strong class="mr-1">Factura:</strong><span class="mr-2"><?= $rt['numero_factura']; ?></span><input id="factura" type="hidden"
                                        value="<?= $rt['factura']; ?>" /><i id="showFactura" class="i-pdf material-icons far fa-file-pdf" title="Ver factura" <?= $rt['factura'] == null ? 'hidden' : '' ?>></i></td>
                                <td class="px-0 mx-0"><i class="mr-1 fas fa-paperclip"></i><strong class="mr-1">XML:</strong> <input type="hidden" id="xml" value="<?= $rt['docXml']; ?>" /><i id="showXml"
                                        class="i-xml material-icons far fa-file-code" title="Ver XML" <?= $rt['docXml'] == null ? 'hidden' : '' ?>></i></td>
                                <td class="px-0 mx-0"><i class="mr-1 fas fa-paperclip"></i><strong class="mr-1">Remisión:</strong><span class="mr-2"><?= $rt['remision']; ?></span><input type="hidden" id="remision"
                                        value="<?= $rt['remision']; ?>" /><i id="showRemision" class="i-pdf material-icons far fa-file-pdf" title="Ver remisión" <?= $rt['remision'] == null ? 'hidden' : '' ?>></i></td>
