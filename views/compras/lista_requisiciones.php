    ...
    <table class="table table-condensed tabla-registros" id="tablaRegistros">
        ...
        <tbody>
            ...
            <tr class="tr">
                ...
                <td>
                    <div id="tdEstatus" class="<?= Utils::getClaseEstado($r['clave']); ?> estatus-tabla" title="<?= $r['descEstatus'] ?>"><span id="estatus"><?= $r['estatus']; ?></span></div>
                </td>
                <?php if ($r['estatus_id'] == 5): ?>
                <td><strong><?= $r['folio_oc']; ?></strong></td>
                <?php else: ?>
                <td>
                    <div><?= Utils::showFirmas($r['firmas']) ?></div>
                </td>
                <?php endif; ?>
                <td>
