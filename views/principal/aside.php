<aside class="aside" id="aside">
    <ul>
        <li title="Compras"><a href="<?= principalUrl ?>?controller=Compras&action=index"><i class="material-icons">local_mall</i><span class="hidden">Compras</span></a><i id="dropMenu"
                class="material-icons expand-menu rotar90">expand_more</i></li>
        ...
        <li>
            <div><span class="material-icons pr-1">home_work</span><span class="hidden">Almacén</span><i id="dropMenu" class="material-icons expand-menu rotar90">expand_more</i></div>
        </li>
        <ul class="menu-drop transparent hidden" id="subMenu">
        ...
        <li title="Servicios"><a href="<?= principalUrl ?>?controller=Servicios&action=index"><i class="material-icons material-symbols-outlined">scale</i><span class="hidden">Servicios</span></a><i id="dropMenu"
                class="material-icons expand-menu rotar90">expand_more</i></li>
        <ul class="menu-drop transparent hidden" id="subMenu">
            ...
            <li><a href="<?= principalUrl ?>?controller=Servicios&action=almacenamientoPiso"><i class="fas fa-circle i-list-circle"></i>Almacenaje</a></li>
        ...
        <li>
            <div><i class="fas fa-laptop pr-1"></i><span class="hidden">Sistemas</span><i id="dropMenu" class="material-icons expand-menu rotar90">expand_more</i></div>
        </li>
        <ul class="menu-drop transparent hidden" id="subMenu">
