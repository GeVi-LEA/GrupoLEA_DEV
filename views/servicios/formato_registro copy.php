...
<body>
    ...
    <div class='caja contenedor'>
        <table style="width:100%;">
            <tr>
                <td>
                    <img src="<?= root_url ?>assets/images/logo_lea-sm.png" alt="" height="100">
                </td>
                <td class='col-10 titulo'>
                    <strong>REGISTRO DE UNIDADES</strong>
                </td>
            </tr>
        </table>
        <div class='row'>
        ...
        <div class='row mt-3 '>
            ...
            <div class='col-7'>
                <div class='row seccion'>
                    <table>
                        <tr>
                            <td> <strong>FOLIO DE LA CARGA</strong></td>
        ...
        <div class='row mt-3 seccion'>
            <div class='col-12'>
                <table style="width:100%">
                    <tr>
                        <td colspan="2"> <strong>NOMBRE DEL OPERADOR: </strong><?= strtoupper(Utils::getChofer($servicios['chofer'])->nombre) ?></td>

                        <td> <strong>LINEA TRANSPORTISTA: </strong><?= strtoupper(Utils::getTransportistaCliente($servicios['transportista'])->nombre) ?></td>

                    </tr>
                    <tr>
                        <td><strong>PLACAS DE UNIDAD/TRACTOR: </strong><?= $servicios['numUnidad'] ?></td>
                        <td> <?= ($servicios['cant_puertas'] > 0) ? '<strong>NO. ECONOMICO: </strong>' . '' /* $servicios['num_economico'] */ : '' ?></td>
                        <td> <?= ($servicios['cant_puertas'] > 0) ? '<strong>NO PUERTAS: </strong>' . $servicios['cant_puertas'] : '' ?></td>
                    </tr>
                    <tr <?= ($servicios['placa1'] == '') ? 'hidden' : '' ?>>
                        <td><strong>PLACAS DEL TANQUE O CAJA: </strong><?= $servicios['placa1'] ?></td>
                        <td><strong>NO. ECONOMICO: </strong> <?= '' /* $servicios['num_economico'] */ ?></td>
                        <td> <strong>CAPACIDAD: </strong> <?= Utils::getTipoTransporte($servicios['tipo_transporte_id'])->cap_maxima ?></td>
                    </tr>
                    <tr <?= ($servicios['placa2'] == '') ? 'hidden' : '' ?>>
                        <td><strong>PLACAS DEL TANQUE O CAJA: </strong><?= $servicios['placa2'] ?></td>
                        <td><strong>NO. ECONOMICO: </strong> <?= '' /* $servicios['num_economico'] */ ?></td>
                        <td> <strong>CAPACIDAD: </strong> <?= Utils::getTipoTransporte($servicios['tipo_transporte_id'])->cap_maxima ?></td>
                    </tr>
                    <tr <?= ($servicios['observaciones'] == '') ? 'hidden' : '' ?>>
                        <td colspan="3"><strong>OBSERVACIONES: </strong><?= $servicios['observaciones'] ?></td>
                    </tr>
                    <tr class="mt-5 center">
                        <td colspan="3" style="width:100%; border-bottom:1px solid black; padding-top:100px;"> </td>
                    </tr>
                    <tr class="center">
                        <td colspan="3"><strong>NOMBRE Y FIRMA DEL GUARDIA EN TURNO</strong></td>
                    </tr>
                </table>
            </div>
        </div>
            ...
            <div class='col-12'>
                ...
                <div class='row'>
                    ...
                    <div class='row' style="text-align: center;">
                        ...
                        <div class='col-12'>
                            <img src="<?= $servicios['firma_entrada'] ?>">
                            <p><?= strtoupper(Utils::getChofer($servicios['chofer'])->nombre) ?></p>
                            <p><strong>Nombre y firma del chofer</strong></p>
                        </div>
                    </div>
                </div>
                <br />
