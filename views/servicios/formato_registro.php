...
<body>
    ...
    <div class='caja contenedor'>
        <div style="width:100%;">
            ...
            <div style="width:80%;" class='col-10 titulo'>
                <b>REGISTRO DE UNIDADES</b>
            </div>
        </div>
        <div class=''>
            <div class=''>
        ...
        <div class='row mt-3 seccion'>
            <div class='col-12'>
                <table style="width:100%">
                    <tr>
                        <td colspan="2"> <b>NOMBRE DEL OPERADOR: </b><?= strtoupper(Utils::getChofer($servicios['chofer'])->nombre) ?></td>

                        <td> <b>LINEA TRANSPORTISTA: </b><?= strtoupper(Utils::getTransportistaCliente($servicios['transportista'])->nombre) ?></td>
                ...
                <div class='row'>
                    ...
                    <div class='row' style="text-align: center;">
                        ...
                        <div class='col-12'>
                            ...
                            <p><b>Nombre y firma del chofer</b></p>
                        </div>
                    </div>
                </div>
                <br />
